      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {videos.map((video, i) => (
            <article
              key={`${video.id}-${i}`}
              className="group overflow-hidden rounded-lg border border-border/60 bg-card transition-all duration-500 hover:shadow-xl hover:shadow-primary/5 hover:border-border"
            >
